...
try
{
    //$sql = "INSERT INTO sentences (spanish_sen, trans_1, trans_2, hint_1, hint_2) VALUES ('$_POST[spanish]','$_POST[english_1]','$_POST[english_2]', '$_POST[hint_1]', '$_POST[hint_2]')";
...
*/
    ...
    $output = 'Sentence included successfully!';
}
